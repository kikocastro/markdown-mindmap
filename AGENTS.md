...
- `src/obsidian/main.ts` — **Obsidian adapter**, the only file importing `obsidian`. Owns host I/O (vault read, resolver, code-block processor, YAML write-back), toolbar/state wiring, and the note `Modal`. Builds `main.js`.
